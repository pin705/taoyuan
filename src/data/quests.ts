...
export const QUEST_TEMPLATES: QuestTemplateDef[] = [
  ...
  },
  {
    ...
    targets: [
      ...
      { itemId: 'catfish', name: '鲶鱼', minQty: 1, maxQty: 2, seasons: ['spring', 'autumn'], unitPrice: 40 },
      { itemId: 'bass', name: '鲈鱼', minQty: 1, maxQty: 2, seasons: ['autumn', 'winter'], unitPrice: 35 },
      { itemId: 'loach', name: '泥鳅', minQty: 1, maxQty: 3, seasons: ['spring', 'summer'], unitPrice: 20 },
      { itemId: 'shrimp', name: '河虾', minQty: 2, maxQty: 4, seasons: ['spring', 'summer', 'autumn'], unitPrice: 15 },
